    ...
    <div class="error-pagewrap">
        <div class="error-page-int">
            <div class="text-center m-b-md custom-login">
                <h3>ARSIP DIGITAL</h3>
                <h4>Sistem Informasi Pengolah Data Sertifikasi</h4>
            ...
            <div class="text-center login-footer">
                <p class="text-muted">Copyright © <?php echo date('Y') ?>. All rights reserved. Sistem Informasi Pengolah Data Sertifikasi (SIAD)</p>
            </div>
        </div>   
    </div>
